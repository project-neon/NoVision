...
void protobuf_AssignDesc_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
void protobuf_AddDesc_messages_5frobocup_5fssl_5fgeometry_5flegacy_2eproto() GOOGLE_ATTRIBUTE_COLD;
