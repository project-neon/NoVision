...
static const char qt_meta_stringdata_CaptureV4L[] = {
    "CaptureV4L\0\0group\0changed(VarType*)\0"
};
...
const QMetaObjectExtraData CaptureV4L::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CaptureV4L::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CaptureV4L,
      qt_meta_data_CaptureV4L, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CaptureV4L::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CaptureV4L))
        return static_cast<void*>(const_cast< CaptureV4L*>(this));
    if (!strcmp(_clname, "CaptureInterface"))
        return static_cast< CaptureInterface*>(const_cast< CaptureV4L*>(this));
